...
# m1 = Projekcija(movie_name='Iron Man', movie_time='132:00:00', capacity=100)
#m1.save()
#m2 = Projekcija(movie_name='Avengers: Endgame', movie_time='182:00:00', capacity=50)
#m2.save()
#m3 = Projekcija(movie_name='Black Panther', movie_time='155:00:00', capacity=70)
#m3.save()
